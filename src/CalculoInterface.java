...
public class CalculoInterface extends JFrame {
    ...
    private void ComponentesCriar() {
		...
		JLabel lblMetro = new JLabel("M");
        lblMetro.setBounds(200, 105, 70, 25);
        getContentPane().add(lblMetro);

		JButton btnCalcular = new JButton(new AbstractAction("Calcular") {
		...
		JButton btnLimpar = new JButton(new AbstractAction("Limpar") {
    ...
    public static void main(String[] args) {
        ...
        new CalculoInterface().setVisible(true);
